...
description: Use when the relevant context is too large to fit in a single model context window (large repos, long logs, big papers/policies) and accurate answers require recursive chunk reading with tools plus subagents/agent teams.
---
